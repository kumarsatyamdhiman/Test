...
def findPeople(features_arr, positions, thres = 0.4, percent_thres = 50):
    ...
    for (i,features_128D) in enumerate(features_arr):
        ...
        now = ''
        crsr.execute("INSERT INTO SD VALUES (?,?);", (result,percentage))
        connection.commit()
    return returnRes    
...
def create_manual_data():
    vs = cv2.VideoCapture("rtsp://admin:Satyam0202@192.168.1.48:554/Streaming/Channels/002"); #get input from webcam
